jQuery(function($) {
			...
			function showDeleteMultiModal1()
			{
			...
			function showTransferMultiModal1()
			{
				//alert($('#leadsCount').val());
				var count = parseInt($('#leadsCount').val());
				if(count)
